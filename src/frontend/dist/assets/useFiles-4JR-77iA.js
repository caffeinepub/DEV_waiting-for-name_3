...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, i as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, k as RequestStatusResponseStatus, U as UnknownError, m as RequestStatusDoneNoReplyErrorCode, n as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, w as Principal, x as IDL, y as MissingCanisterIdErrorCode, H as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, D as isV3ResponseBody, G as isV2ResponseBody, J as UncertifiedRejectUpdateErrorCode, K as UnexpectedErrorCode, N as decode, O as Subscribable, V as pendingThenable, W as resolveEnabled, X as shallowEqualObjects, Y as resolveStaleTime, Z as noop, _ as environmentManager, $ as isValidTimeout, a0 as timeUntilStale, a1 as timeoutManager, a2 as focusManager, a3 as fetchState, a4 as replaceData, a5 as notifyManager, a6 as hashKey, a7 as getDefaultState, r as reactExports, a8 as shouldThrowError, a9 as useQueryClient, aa as useInternetIdentity, ab as createActorWithConfig, c as createLucideIcon, ac as useAuth, j as jsxRuntimeExports, L as Link, ad as ShieldCheck, B as Button, ae as Record, af as Opt, ag as Variant, ah as Vec, ai as Service, aj as Func, ak as Nat, al as Nat8, am as Text, an as Bool, ao as Null, ap as Int, aq as Principal$1 } from "./index-DhSg41Tm.js";
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent/20 flex items-center justify-center border border-accent/30 group-hover:bg-accent/30 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: "FileVault" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
      isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        principalShort && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground", children: [
      "© ",
...
Service({
  ...
  "getFile": Func([FileId], [Opt(FileMetadata)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listFiles": Func([], [Vec(FileMetadata)], ["query"]),
  "uploadFile": Func([UploadFileArgs], [FileId], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const UploadFileArgs2 = IDL2.Record({
    "blob": ExternalBlob2,
    "name": IDL2.Text,
    "size": IDL2.Nat,
    "mimeType": IDL2.Text
  ...
  return IDL2.Service({
    ...
    "getFile": IDL2.Func([FileId2], [IDL2.Opt(FileMetadata2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listFiles": IDL2.Func([], [IDL2.Vec(FileMetadata2)], ["query"]),
    "uploadFile": IDL2.Func([UploadFileArgs2], [FileId2], [])
  });
};
...
class Backend {
  ...
  async uploadFile(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.uploadFile(await to_candid_UploadFileArgs_n17(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
async function from_candid_FileMetadata_n13(_uploadFile, _downloadFile, value) {
...
async function to_candid_UploadFileArgs_n17(_uploadFile, _downloadFile, value) {
...
function useGetFile(fileId) {
  const { actor, isFetching: actorFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["file", fileId == null ? void 0 : fileId.toString()],
    queryFn: async () => {
